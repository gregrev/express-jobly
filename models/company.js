...
class Company {
  ...
  static async findAll(searchFilters = {}) {
    // preparing the query without the WHERE clause
    let query = `SELECT handle,
                        ...
                        logo_url AS "logoUrl"
                 FROM companies`;
    // these arrays are going to store the WHERE and the query values expressions that are generated
    ...
    // add query strings to whereExpressions array, make sure to parameterize query.
    // queryValues will be the values used to add to generated query and original query.
